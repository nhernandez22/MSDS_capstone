...
```
      At the state level, we found that a majority of routes fall in the Area Classic to Classic class with outliers in the Bad to Bomb class. But what about at the grade level?
```{r, echo = FALSE}
or_ratings %>%
  group_by(state) %>%
